...
const mockData = {
  ...
  project: {
    projectName: (index) => projectName[index]
  },
  release: {
    releaseName: (index) => releaseName[index]
  },
  module: {
  ...
  testCase: {
    testCaseName: (index) => testCaseName[index]
  },
  testCaseId: (index) => `PUR${index + 1}`,

  testCaseStep: {
    testCaseStepName: (index) => testCaseStepName[index]
  },
  text: {
