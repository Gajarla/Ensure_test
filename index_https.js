...
if (cluster.isMaster) {
    ...
    try {
        ...
        const sslOptions = {
            key: fs.readFileSync('/home/teadmin/TE_backend/ssl/testensure.pem'),
            cert: fs.readFileSync(
                '/home/teadmin/TE_backend/ssl/testensure.pem'
            ),
            passphrase: '',
        ...
        server.listen(app.get('port'), () => {
            console.log(
                `Worker ${process.pid} running HTTPS on port ${app.get('port')}`
            )
        })
